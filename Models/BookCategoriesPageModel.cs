...
namespace Serb_Diana_Lab8.Models
{
    public class BookCategoriesPageModel:PageModel
    {
        public List<AssignedCategoryData> AssignedCategoryDataList;
            public void PopulateAssignedCategoryData(Serb_Diana_Lab8Context context, Book book)
            { 
        ...
        public void UpdateBookCategories(Serb_Diana_Lab8Context context, string[] selectedCategories, Book bookToUpdate)
        {
